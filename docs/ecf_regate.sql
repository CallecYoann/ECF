...
--
-- Host: localhost
-- Generation Time: Mar 03, 2017 at 12:00 PM
...
-- Functions
--
CREATE DEFINER=`root`@`localhost` FUNCTION `new_code_regate` (`id_regate1` INT) RETURNS VARCHAR(20) CHARSET latin1 BEGIN
...
INSERT INTO `challenge` (`id_challenge`, `nom_challenge`, `date_debut`, `date_fin`, `code_challenge`) VALUES
(1, 'Challenge Hiver', '2016-11-15', '2017-03-31', 'CHA1'),
(2, 'Challenge Ete', '2017-05-15', '2017-09-30', 'CHA2'),
(3, 'test3', '2016-06-23', '2016-10-18', 'CHA3');
...
INSERT INTO `PARTICIPER` (`point`, `temps_comp`, `temps_reel`, `id_voilier`, `id_regate`) VALUES
(1, '00:00:00', '06:00:00', 1, 1),
(2, '00:00:00', '07:00:00', 2, 1);
...
--
ALTER TABLE `proprietaire`
  MODIFY `id_proprietaire` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `voilier`
  MODIFY `id_voilier` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
